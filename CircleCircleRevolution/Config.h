...
#define buttonUpPath [[NSBundle mainBundle] pathForResource:@"button11" ofType:@"wav"]
#define buttonUpURL [NSURL fileURLWithPath:buttonUpPath]
#define buttonDownPath [[NSBundle mainBundle] pathForResource:@"button25" ofType:@"wav"]
